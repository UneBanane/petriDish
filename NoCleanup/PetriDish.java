...
public class PetriDish {
	...
	static ArrayList<String> srcMap = new ArrayList<String>(); // to remove later and adapt if possible >>> only used
																// during init.
	...
	private static int init(String args) {
		...
		// should be useless but is a good parachute.
		// if (srcMap == null) {
		// 	return -1;
		// }
	...
	private static int getMapLen(ArrayList<String> srcMap) {
		...
		// System.err.println("content size check done");
		return width;
	}
